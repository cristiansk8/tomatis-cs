...
function bst_enqueues() {
	...
	wp_register_script('fancy-js', get_template_directory_uri() . '/assets/js/vendors/jquery.fancybox.min.js', false, null, true);
	wp_enqueue_script('fancy-js');

	wp_register_script('counter-js', get_template_directory_uri() . '/js/counterup.js', false, null, true);
